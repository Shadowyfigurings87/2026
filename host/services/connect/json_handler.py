...
# NEW ministry handlers
from host.services.connect.esp32_handler import handle_esp32_json
# from host.services.connect.arduino_handler import handle_arduino_json   # future
# from host.services.connect.rf_handler import handle_rf_json             # future
...
def route_ministry(obj, ministry):
    ...
    # Camera handled separately above
...
def handle_json_client(conn, addr):
    ...
    # Register this socket as rover uplink
